...
groq_client = None
groq_api_key = os.getenv("GROQ_API_KEY", "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")
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Starting Chat Toxicity Moderator...")
    print(f"✅ Groq API: {'Configured (llama-3.3-70b-versatile)' if groq_client else 'Not configured - using T5 fallback'}")
